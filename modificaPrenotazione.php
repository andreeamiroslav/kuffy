<html lang="it_IT" dir="ltr">
  <head>
    <title>Modifica prenotazione - Kuffy</title>
    <meta charset="utf-8">
  ...
  <body onload="initDate(); getStructures(); getRooms('<?php echo $_GET['id'] ?>');">
        ...
        <form id="firstForm" method="post" action="/Queries/addReservation.php?num=0&resID=<?php echo $_GET['id'] ?>&stanzaidd=<?php echo $_GET['stanzaid'] ?>">
          ...
          <div id="client">
            ...
            <div class="row" id="name-surname">
              ...
              <div class="input-field col s4">
                <input placeholder="Cognome" id="surname" type="text" class="validate">
            ...
            <div class="row" id="name-surname">
              <div class="input-field col offset-s1 s4">
                <input placeholder="Provenienza" id="provenienza" type="text" class="validate">
