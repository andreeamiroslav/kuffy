document.write('<ul id="dropdown2" class="dropdown-content"></ul><nav id="mobileNav"><div class="con"> <a href="#" data-target="slide-out" class="show-on-large sidenav-trigger"><img class="menuIcon" src="/Icone/Mobile/hamburgerMenu.png" /></a> <a href="index.php" id="navName">KUFFY</a></div></nav><ul id="slide-out" class="sidenav"><li class="navbarText"><a href="strutture.php" class = "dropdown-trigger" data-target="dropdown2">Strutture</a></li><li class="navbarText"><a href="aggiungiPrenotazione.php">Aggiungi prenotazione</a></li></ul><ul id="nav-mobile" class = "right hide-on-med-and-down"><li ><a href="" id="utente" class = "dropdown-trigger" data-target="dropdown1" >Utente     <img src="Icone/user.png" id="user-icon"/></a></li></ul> ');
