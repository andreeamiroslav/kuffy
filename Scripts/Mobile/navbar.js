document.write('<nav id="mobileNav"><div class="con"> <a href="#" data-target="slide-out" class="show-on-large sidenav-trigger"><img class="menuIcon" src="/Icone/Mobile/hamburgerMenu.png" /></a> <a href="index.php" id="navName">KUFFY</a></div></nav>  <ul id="slide-out" class="sidenav"><li>Ciaone</li><li>Ciaino</li>  </ul> ');
/*
